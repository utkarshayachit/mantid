...
public:
  ...
  void test_rename()
  {
    ...
    TSM_ASSERT_EQUALS("The observers should have been called 4 times in total", notificationFlag, 2 );
    ...
    TSM_ASSERT_EQUALS("The observers should have been called 6 times in total", notificationFlag, 4 );
