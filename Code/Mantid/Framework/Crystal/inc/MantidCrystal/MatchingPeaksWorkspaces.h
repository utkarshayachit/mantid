#ifndef MANTID_CRYSTAL_MATCHINGPEAKSWORKSPACES_H_
#define MANTID_CRYSTAL_MATCHINGPEAKSWORKSPACES_H_
...
namespace Crystal
{
  ...
  */
  class DLLExport MatchingPeaksWorkspaces  : public API::Algorithm
  {
  public:
    MatchingPeaksWorkspaces();
    virtual ~MatchingPeaksWorkspaces();
...
#endif  /* MANTID_CRYSTAL_MATCHINGPEAKSWORKSPACES_H_ */
